...
//    public static String DEFAULT_UI = "swt"; // if this is enabled, run Main with --ui=console argument for launching CLI mode
    public static String DEFAULT_UI = "console"; // EDITED BY PGP no swt, use CLI
...
//        /**
//         * BEGIN Inject --ui=console
//         */
//        List<String> tmp = Arrays.asList(args);
//        tmp = Arrays.asList(tmp.get(0),"--ui=console");
//        args = new String[tmp.size()];
//        tmp.toArray(args);
//        /**
//         * END Inject --ui=console
//         */


        // COMMENTED BY PGP, TRY AVOIDING CLASSLOADER-RELATED STUFF
