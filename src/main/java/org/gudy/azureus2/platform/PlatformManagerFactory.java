...
PlatformManagerFactory 
{
					...
					if ( !explicit_class ){
						...
						switch (platformType) {
							...
							case PlatformManager.PT_UNIX:
								...
								break;
							case PlatformManager.PT_ANDROID:
								cla = "it.pgp.squerez.utils.PlatformManagerImpl";
								break;
							default:
	...
	getPlatformType()
	{
		if (Constants.isWindows) return PlatformManager.PT_WINDOWS;
		else if (Constants.isAndroid) return PlatformManager.PT_ANDROID;
		else if (Constants.isOSX) return PlatformManager.PT_MACOSX;
		else if (Constants.isUnix) return PlatformManager.PT_UNIX;
		else return PlatformManager.PT_OTHER;
	}
}
