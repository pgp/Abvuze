...
import org.gudy.azureus2.ui.console.StandardConsoleInputHelperFactory;
...
Constants 
{
  ...
  public static final long   CRAPPY_INFINITE_AS_LONG = 10000*365*24*3600L; // seconds (10k years)
  ...
  public static final String AZUREUS_VERSION  = "5.7.6.2-Abvuze";
  ...
  static{
	  ...
	  if(isAndroid) {
		  try {
			  Class classType = Class.forName("it.pgp.squerez.factory.AndroidConsoleInputHelperFactory");
			  ConsoleInputHelperFactory.instance = (ConsoleInputHelperFactory)classType.newInstance();
		  } catch (ClassNotFoundException | IllegalAccessException | InstantiationException e) {
			  throw new RuntimeException(e);
		  }
	  }
	  else ConsoleInputHelperFactory.instance = new StandardConsoleInputHelperFactory();
  }
